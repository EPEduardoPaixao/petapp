...
class Animal_5 extends Component {
...
<Form.Group as={Row} className= "mx-auto ">
          <Card className='mx-auto' border="primary" style={{ width: '18rem' }}>
              <Card.Header>Raça: Scottish Fold</Card.Header>
              <Card.Body>
                <Card.Title>Ammy</Card.Title>
                  <Card.Img src={Dog5} />
                  <Card.Text  >
          ...
          <ul class="pet-check">
            ...
            <li>Porte: Pequeno.</li>
            <li>Idade: 1 mês.</li>
            <li>informações adicionais: fofinha, carinhosa e amigavel. </li>
          </ul>
